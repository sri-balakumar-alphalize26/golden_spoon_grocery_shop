...
class AccountMoveSourceModule(models.Model):
    ...
    is_fully_returned_purchase = fields.Boolean(
        string='Fully Returned (Purchase)',
        compute='_compute_is_fully_returned_purchase',
        store=True,
        index=True,
    ...
    def _compute_is_fully_returned_purchase(self):
        """
        ...
        for move in self:
            ...
            if move.move_type != 'in_invoice' or move.state != 'posted':
                move.is_fully_returned_purchase = False
                continue
            ...
            move.is_fully_returned_purchase = fully_returned
