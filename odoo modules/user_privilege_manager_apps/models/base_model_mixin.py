...
# Includes BOTH renamed (.app) names and original names so that if both
# user_privilege_manager_ and user_privilege_manager_apps are installed
# side-by-side, neither module's privilege tables are recursively checked.
EXCLUDED_MODELS = {
    # Apps-build privilege models (.app suffix)
    'user.privilege.app', 'module.privilege.app', 'module.privilege.line.app',
    'menu.privilege.app', 'privilege.role.app', 'role.privilege.line.app',
    'role.menu.visibility.app', 'role.module.visibility.app', 'module.visibility.app',
    'special.menu.privilege.app', 'app.feature.app', 'app.feature.visibility.app',
    'role.app.feature.visibility.app',
    # Original module names (for safe coexistence)
    ...
    'special.menu.privilege', 'app.feature', 'app.feature.visibility',
    'role.app.feature.visibility',
    # Odoo internals
...
def _get_priv(env, model_name):
    ...
    try:
        with _Bypass():
            return env['user.privilege.app'].get_user_privilege(model_name)
    except Exception:
        return None
